...
<section class='container'>
          <hgroup>
            <h1>Welkom op je Ruby Applicatie in OpenShift</h1>
          </hgroup>
        ...
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Deploying code veranderingen</h2>
                <p>
                  De bron code for this application is available to be forked from the <a href="https://www.github.com/sclorg/ruby-ex">OpenShift GitHub repository</a>.
